...
BC_real=load('../Data/Mat_Files/BC_REAL.mat');
BC_all=load('../Data/Mat_Files/BC_ALL.mat');
BC_pbl=load('../Data/Mat_Files/BC_PBL.mat');
BC_wind=load('../Data/Mat_Files/BC_WIND.mat');
BC_rain=load('../Data/Mat_Files/BC_RAIN.mat');
...
% Annotation
TD.SText(STATS(1,1),STATS(2,1),STATS(3,1),{' ';' '},'FontWeight','bold',...
...
saveas(gcf,"../../Figures/Figure5_对比考虑所有与去除边界层的泰勒图.svg")
