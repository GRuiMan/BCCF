...
modiBl_height2 = smoothdata(modiBl_height, "gaussian", 45);
...
namcopbl2=smoothdata(namcopbl2,"gaussian",45);
plot(ctime,modiBl_height2+600,'LineWidth',1.5)
hold on
plot(ctime,namcopbl2 ,'LineWidth',1.5)
xlabel("Time")
ylabel("Height(m)")
...
legend("simulated boundary layer height","actual boundary layer height")
box off
set(gca, 'FontName', 'Times New Roman')
% saveas(gcf,"边界层高度.svg")
